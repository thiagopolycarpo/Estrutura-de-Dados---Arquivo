...
int inserir(FILE **arq){
  ...
  //Inserindo no meio do arquivo se tiver espaÁo disponivel com tamanho que caiba registro
	if(offset != -1){
		...
		while(achou != 1 && proximo != -1){
			...
			fread(&proximo, sizeof(int), 1, *arq);			//pega a posiÁ„o do proximo registro na lista
			printf("\nproximo elemento: %d\n", proximo);
